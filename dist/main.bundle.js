...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_page_state_service__ = __webpack_require__("../../../../../src/app/services/page.state.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__services_page_state_service__["a" /* PageStateService */]
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ts_models_user_model__ = __webpack_require__("../../../../../src/app/ts models/user.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__URLSwitcher__ = __webpack_require__("../../../../../src/URLSwitcher.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser__ = __webpack_require__("../../../platform-browser/esm5/platform-browser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_page_state_service__ = __webpack_require__("../../../../../src/app/services/page.state.service.ts");
...
var LocationProfileComponent = /** @class */ (function () {
    function LocationProfileComponent(locationService, router, sanitzer, userService, pageStateService) {
        var _this = this;
        this.locationService = locationService;
        this.router = router;
        ...
        if (localStorage.getItem('currloc')) {
            ...
            this.userService.getUser(this.location.user).subscribe(function (data) {
                console.log(data);
                _this.user = data.obj;
            });
        }
        ...
        this.ImgUrl = 'http://' + __WEBPACK_IMPORTED_MODULE_4__URLSwitcher__["a" /* Dev */] + '/files/' + this.location._id;
    ...
    LocationProfileComponent.prototype.ngOnDestroy = function () {
    ...
    LocationProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_location_service__["a" /* LocationService */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__services_page_state_service__["a" /* PageStateService */]])
...
/***/ "../../../../../src/app/main/main-toolbar/main-toolbar.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_page_state_service__ = __webpack_require__("../../../../../src/app/services/page.state.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainToolbarComponent = /** @class */ (function () {
    function MainToolbarComponent(router, locationService, authService, pageStateService) {
        this.router = router;
        this.locationService = locationService;
        this.authService = authService;
        this.pageStateService = pageStateService;
    ...
    MainToolbarComponent.prototype.routeToPost = function () {
    ...
    MainToolbarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/main/main-toolbar/main-toolbar.component.html"),
            styles: [__webpack_require__("../../../../../src/app/main/main-toolbar/main-toolbar.component.scss")],
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */],
            __WEBPACK_IMPORTED_MODULE_2__services_location_service__["a" /* LocationService */],
            __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_4__services_page_state_service__["a" /* PageStateService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_page_state_service__ = __webpack_require__("../../../../../src/app/services/page.state.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainComponent = /** @class */ (function () {
    function MainComponent(iconRegistry, sanitizer, dialog, searchService, authService, SearchService, pageStateService, router) {
        this.iconRegistry = iconRegistry;
        this.sanitizer = sanitizer;
        this.dialog = dialog;
    ...
    MainComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["l" /* MatIconRegistry */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_6__services_search_service__["a" /* SearchService */],
            __WEBPACK_IMPORTED_MODULE_7__services_page_state_service__["a" /* PageStateService */],
            __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */]])
    ], MainComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__main_toolbar_main_toolbar_component__ = __webpack_require__("../../../../../src/app/main/main-toolbar/main-toolbar.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    MainModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__main_toolbar_main_toolbar_component__["a" /* MainToolbarComponent */],
            ]
        })
    ], MainModule);
    return MainModule;
...
module.exports = "<agm-map #googlemap [latitude]=\"CurrentLocation.lat\" [longitude]=\"CurrentLocation.lng\" [styles]=\"\">\n  <agm-marker\n    *ngFor=\"let location of locations\n     | filter: searchString: 'name'\n     | typeFilter: typeObject\n     | electricityFilter: electrictyObject\n     | bathroomFilter: bathroomObject\n     | rateFilter: rateObject\n\"\n    (markerClick)=\"toLocationProfile(location)\"\n    [latitude]=\"location.coordinates.lat\"\n    [longitude]=\"location.coordinates.lng\"\n    [iconUrl]=\"'./../../../../assets/icons/'+ location.type +'.png'\">\n  </agm-marker>\n</agm-map>\n\n"
...
var MapComponent = /** @class */ (function () {
    function MapComponent(searchService, locationService) {
        this.searchService = searchService;
        this.locationService = locationService;
    ...
    MapComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_search_service__["a" /* SearchService */], __WEBPACK_IMPORTED_MODULE_2__services_location_service__["a" /* LocationService */]])
    ], MapComponent);
    return MapComponent;
}());
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(dialog, snackBar, authService, router, iconRegistry, sanitizer, LocationService, searchService, pageStateService) {
        this.dialog = dialog;
        this.snackBar = snackBar;
        this.authService = authService;
        this.router = router;
...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(authService, router, fileService, uploadService, _formBuilder, pageStateService) {
        this.authService = authService;
        this.router = router;
        this.fileService = fileService;
        this.uploadService = uploadService;
...
/***/ "../../../../../src/app/services/page.state.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PageStateService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var PageStateService = /** @class */ (function () {
    ...
    PageStateService.prototype.isOpen = function () {
        if (this.Location) {
            return 'Location';
        }
        else if (this.Upload) {
...
/***/ "../../../../../src/app/ts models/user.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var User = /** @class */ (function () {
    function User(email, username, firstName, lastName, smallthumb, largethumb) {
