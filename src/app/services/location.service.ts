...
export class LocationService    {
  ...
  getLocation(location_id: string) {
    return this.http.get('http://' + Prod + '/location/find?_ID=' + location_id)
  ...
  getLocations() {
    return this.http.get('http://' + Prod + '/location')
      .map((response: Response) => {
  ...
  saveLocation(location: Location) {
        ...
        const token = localStorage.getItem('id_token')
            ...
            : '';
        return this.http.post('http://' + Prod + '/location' + token , body, {headers: headers})
