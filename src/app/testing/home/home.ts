...
export class Home implements OnInit {
  ...
  url = this.sanitizer.bypassSecurityTrustResourceUrl('https://' + Dev +  '/pdf/viewPDF?ignore=' + this.rand);
          ...
          data => {
            ...
            this.pdfService.updateAgreement1(formData)
              .subscribe(
                data => {
                  console.log(data);
                  const url1 = this.sanitizer.bypassSecurityTrustResourceUrl('https://' + Dev +  '/pdf/viewPDF?ignore=' + this.rand);
                  this.url = url1;
                },
                error =>  {
                  console.error(error);
